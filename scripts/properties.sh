...
# - https://github.com/termux/termux-packages/wiki/Termux-file-system-layout#termux-private-app-data-directory
#
# LibGhostty builds use a separate Android application and data directory so
# they can coexist with stock Termux.
#
# Default value: `com.termux`
##
TERMUX_APP__PACKAGE_NAME="com.termux_libghostty"
...
TERMUX_REPO_APP__PACKAGE_NAME="com.termux_libghostty"
TERMUX_REPO_APP__DATA_DIR="/data/data/com.termux_libghostty"
TERMUX_REPO__CORE_DIR="/data/data/com.termux_libghostty/termux/core"
TERMUX_REPO__APPS_DIR="/data/data/com.termux_libghostty/termux/app"
TERMUX_REPO__ROOTFS="/data/data/com.termux_libghostty/files"
TERMUX_REPO__HOME="/data/data/com.termux_libghostty/files/home"
TERMUX_REPO__PREFIX="/data/data/com.termux_libghostty/files/usr"
